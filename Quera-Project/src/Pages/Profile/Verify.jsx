...
export const Verify=()=>{
    ...
    return(
        ...
        <article dir="rtl"  className="flex float-right font-dana mr-[58px] mt-[170px] w-[354px]  flex-col">
            ...
            </section><form onSubmit={handleSubmit(onsubmit)}>
            <section>
            ...
            <section><input type="submit" value="ثبت تغییرات" className="  cursor-pointer w-full  h-[38px] text-sm rounded-md font-dana bg-submitColor text-white  "/></section></form>
        </article>
        </>
    )
}