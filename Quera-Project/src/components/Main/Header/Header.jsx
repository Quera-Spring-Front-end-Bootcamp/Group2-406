    ...
    return(
        <header className='w-[1080px] h-[110px] flex flex-row justify-end mr-5 border-solid border-b-2 border-gray-200'>
            ...
            <section className='flex flex-row-reverse items-end'>
                ...
                {/* list view  */}
                <article className="ml-3 mr-0 pb-7 flex flex-row justify-end items-center w-[150px] h-[25px] border-solid border-b-2 border-teal-500">
                ...
                {/* column display */}
                <article className="ml-3 mr-0 pb-7 flex flex-row justify-end items-center w-[160px] h-[25px]">
                ...
                {/* calender */}
                <article className="mr-0 pb-7 flex flex-row justify-end items-center w-[90px] h-[25px] ">
                ...
                {/* share */}
                <article className="mr-0 pb-7 font-semibold flex flex-row justify-start items-center w-[555px] h-[25px]">
