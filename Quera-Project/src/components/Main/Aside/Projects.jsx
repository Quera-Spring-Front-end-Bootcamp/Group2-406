    ...
    return(
        ...
        className="flex  transition-height flex-row-reverse justify-between items-end bg-asideProject rounded h-[33px] pr-1 mt-4 group/lesson">
            ...
            <span className='relative'>
                <span className="mt-4 opacity-0 group-hover/lesson:opacity-100 transition-all duration-300">{<MoreHorizRoundedIcon onClick={()=>{setshow(!show)}} className="!text-base text-gray-600"></MoreHorizRoundedIcon>}</span>
