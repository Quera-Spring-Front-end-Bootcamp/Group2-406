    ...
    return (
        <div>
            ...
            <div className="flex flex-row-reverse justify-start mt-4 group/lesson">
                ...
                <span className='relative'><span className=" text-start opacity-0 group-hover/lesson:opacity-100 transition-all duration-300">{<MoreHorizRoundedIcon onClick={()=>{setShow(!show)}} className="!text-base text-gray-600"></MoreHorizRoundedIcon>} 
               </span> <Dropdown dropdown={show} setInner={setInner} setShow={setShow} setprojects={setprojects} projects={projects}/></span>
