    ...
    <section className="w-full h-[60px] flex flex-row-reverse  border-solid border-b-2 border-gray-200">
      <article>
        <form className="w-[245px] mt-4 pl-14 border-solid border-l-2 border-gray-200 ">
          <input
            dir="rtl"
            className="font-dana w-full pr-8 font-medium text-xs   rounded focus:outline-none"
            type="search"
            name="search-statusHeader"
      ...
      <article className=" mr-10 flex flex-row-reverse items-center justify-end">
        <button className="flex flex-row-reverse items-center">
          ...
          <span className="  mr-2  flex items-center font-semibold text-[13px] font-dana">
            فیلترها
          </span>
        </button>
        <span className="  mr-5 p-1 rounded bg-sky-100 flex items-center font-semibold text-[13px]  font-dana">
