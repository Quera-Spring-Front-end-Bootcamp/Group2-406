...
<SearchIcon className=' text-[#208D8E] ml-2'/><input className='w-[100px] outline-none font-dana  tex-[10px]' ref={input} onBlur={()=>{ setShowType(false)}} onClick={()=>{input.current.focus(),setShowType(true)}} type='text' placeholder="جستجو بین فیلتر‌ها"/>
        </li>
