export const Phase1=({setshow,register,errors})=>{
    return ( <><div className="w-full flex flex-row  mb-10"><span onClick={()=>{setshow(false)}} className=" cursor-pointer  text-2xl -translate-y-1  float-right">&times;</span>
        <div className="inline-flex justify-center w-full flex-row ">
            <span className="   font-extrabold text-2xl tracking-tight font-dana ml-3  ">ساختن ورک‌اسپیس جدید‌</span></div></div>
        <div className=" flex  flex-col w-full mb-auto px-1 "><p className="mb-2 font-dana font-semibold  text-sm">نام ورک‌اسپیس</p>
