...
,"#F1A25C","#E28A60","#6897C2","#74AADD","#3C45E7","#6DAFCE","#6CB2F7","#9286EA","#C074D1","#486774","#5F6C7C","#46494D","#7FA1D1"]
    ...
    <div className="inline-flex justify-center  w-full flex-row ">
        <span className="  justify-self-center font-extrabold text-2xl tracking-tight font-dana  self-center">انتخاب رنگ ورک‌اسپیس</span></div><KeyboardBackspaceIcon onClick={()=>{setphase(1)}} /></div>
